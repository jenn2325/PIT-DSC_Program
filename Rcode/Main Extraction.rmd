...
```{r}
whoWeAre <- read.csv("../Data/chp-fulldata.csv")
...
#### Air Pollution
```{r}
Air_Pollution <- read.csv("../Data/AirPollution.csv") %>% 
  .[,-1] %>% 
...
```{r}
library(xlsx)
write.xlsx(data.frame(whoWeAre), file="../Output/NYC_CHP_DATA.xlsx", sheetName="WhoWeAre",append=TRUE)
write.xlsx(Education, file="../Output/NYC_CHP_DATA.xlsx", sheetName="Education", append=TRUE)
write.xlsx(EconomicStress, file="../Output/NYC_CHP_DATA.xlsx", sheetName="EconomicStress", append=TRUE)
write.xlsx(Violence, file="../Output/NYC_CHP_DATA.xlsx", sheetName="Violence", append=TRUE)
write.xlsx(HousingNeighbourhoodConditions, file="../Output/NYC_CHP_DATA.xlsx", sheetName="Housing", append=TRUE)
write.xlsx(Maternal_Child, file="../Output/NYC_CHP_DATA.xlsx", sheetName="Maternal_Child", append=TRUE)
write.xlsx(Healthy_Living, file="../Output/NYC_CHP_DATA.xlsx", sheetName="HealthyLiving", append=TRUE)
write.xlsx(Healthcare, file="../Output/NYC_CHP_DATA.xlsx", sheetName="Healthcare", append=TRUE)
write.xlsx(HealthOutcomes, file="../Output/NYC_CHP_DATA.xlsx", sheetName="HealthOutcomes", append=TRUE)
```
